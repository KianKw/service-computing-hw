...
* 阿里云容器镜像服务实践
    ...
    * 标签
        ...
        ```shell
        docker tag hello-world registry.cn-shenzhen.aliyuncs.com/pmlpml/repo:helloworld
        ```
    ...
    * 标签
        ...
        ```shell
        docker tag registry.cn-shenzhen.aliyuncs.com/pmlpml/repo:hello-world helloworld
        ```
